...
const Sidebar = ({ isOpen, isMobileView, setIsOpen }) => {
  ...
  // ฟังก์ชันสำหรับจัดการเมื่อเมาส์เลื่อนมาที่ sidebar
  ...
  // ฟังก์ชันสำหรับจัดการเมื่อเมาส์เลื่อนออกจาก sidebar
  const handleMouseLeave = () => {
    setIsHovered(false);
  };

  // คำนวณสถานะการเปิดของ sidebar
          ...
          {menuItems.map((item, index) => (
            <li key={index}>
              ...
              >
                ...
                {/* แสดง label เฉพาะตอน sidebar เปิดหรือเมื่อมีการ hover */}
                <span className={effectivelyOpen ? "block" : "hidden"}>
                  {item.label}
                </span>
              </Link>
            </li>
